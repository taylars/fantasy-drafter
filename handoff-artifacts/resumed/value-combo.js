...
/* Heuristic value of the best legal lineup this roster can field.
 *
...
function departures(available, picks, seed) {
  ...
  for (let r = 0; r < ROLLOUTS; r++) {
    ...
    rolls.push(roll);
    const order = new Float64Array(k);
    for (let j = 0; j < k; j++) order[j] = random();
    orders.push(order);
  }
