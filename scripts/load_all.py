...
import db
from scripts import init_db, load_drafts, load_leagues, load_players, load_users
...
def main() -> None:
    ...
    conn = db.connect()
    print("\n== summary")
    for table in ("users", "leagues", "user_leagues", "rosters", "drafts", "draft_picks", "players"):
